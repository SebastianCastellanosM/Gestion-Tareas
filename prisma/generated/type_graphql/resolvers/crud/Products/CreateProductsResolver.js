...
exports.CreateProductsResolver = void 0;
...
let CreateProductsResolver = class CreateProductsResolver {
...
], CreateProductsResolver.prototype, "createProducts", null);
CreateProductsResolver = (0, tslib_1.__decorate)([
    TypeGraphQL.Resolver(_of => Products_1.Products)
], CreateProductsResolver);
exports.CreateProductsResolver = CreateProductsResolver;
